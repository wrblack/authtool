    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <p class="lead">Student ID: <?= $row['idStudent']; ?></p><br>
                <p class="lead">Name: <?= $row['name']; ?></p><br>
                <p class="lead">Email: <?= $row['email']; ?></p><br>
                <p class="lead">Userame: <?= $row['username']; ?></p><br>
                <!-- <p class="lead"><?php print_r($row); ?></p> -->
            </div>
        </div>
    </div>
